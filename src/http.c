...
{
  /* If content-type is not given, assume text/html if opt.assume_texthtml.
     This is because of the multitude of broken CGI's that "forget" to generate
     the content-type.  */
  if ((!type && opt.assume_texthtml) ||
      (type && (0 == c_strcasecmp (type, TEXTHTML_S) ||
